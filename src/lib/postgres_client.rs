...
use {
    crate::lib::geyser_plugin_postgres::{GeyserPluginPostgresConfig, GeyserPluginPostgresError},
    crate::postgres_client::{
        postgres_client_account_index::TokenSecondaryIndexEntry,
...
pub const MAX_ASYNC_REQUESTS: usize = 40960;
pub const DEFAULT_POSTGRES_PORT: u16 = 5432;
pub const DEFAULT_THREADS_COUNT: usize = 100;
pub const DEFAULT_ACCOUNTS_INSERT_BATCH_SIZE: usize = 10;
...
pub struct PostgresSqlClientWrapper {
    pub client: Client,
    pub update_account_stmt: Statement,
    pub bulk_account_insert_stmt: Statement,
    pub update_slot_with_parent_stmt: Statement,
    pub update_slot_without_parent_stmt: Statement,
    pub update_transaction_log_stmt: Statement,
    pub update_block_metadata_stmt: Statement,
    pub insert_account_audit_stmt: Option<Statement>,
    pub insert_token_owner_index_stmt: Option<Statement>,
    pub insert_token_mint_index_stmt: Option<Statement>,
    pub bulk_insert_token_owner_index_stmt: Option<Statement>,
    pub bulk_insert_token_mint_index_stmt: Option<Statement>,
}

pub struct SimplePostgresClient {
    pub batch_size: usize,
    pub slots_at_startup: HashSet<u64>,
    pub pending_account_updates: Vec<DbAccountInfo>,
    pub index_token_owner: bool,
    pub index_token_mint: bool,
    pub pending_token_owner_index: Vec<TokenSecondaryIndexEntry>,
    pub pending_token_mint_index: Vec<TokenSecondaryIndexEntry>,
    pub client: Mutex<PostgresSqlClientWrapper>,
}

pub struct PostgresClientWorker {
    pub client: SimplePostgresClient,
    /// Indicating if accounts notification during startup is done.
    pub is_startup_done: bool,
}
...
impl SimplePostgresClient {
    ...
    pub fn build_bulk_account_insert_statement(
        client: &mut Client,
    ...
    pub fn build_single_account_upsert_statement(
        client: &mut Client,
        config: &GeyserPluginPostgresConfig,
    ) -> Result<Statement, GeyserPluginError> {
    ...
    pub fn prepare_query_statement(
        client: &mut Client,
        config: &GeyserPluginPostgresConfig,
        stmt: &str,
    ) -> Result<Statement, GeyserPluginError> {
    ...
    pub fn build_account_audit_insert_statement(
        client: &mut Client,
        config: &GeyserPluginPostgresConfig,
    ) -> Result<Statement, GeyserPluginError> {
    ...
    pub fn build_slot_upsert_statement_with_parent(
        client: &mut Client,
        config: &GeyserPluginPostgresConfig,
    ) -> Result<Statement, GeyserPluginError> {
    ...
    pub fn build_slot_upsert_statement_without_parent(
        client: &mut Client,
        config: &GeyserPluginPostgresConfig,
    ) -> Result<Statement, GeyserPluginError> {
    ...
    pub fn upsert_account_internal(
        account: &DbAccountInfo,
        statement: &Statement,
        client: &mut Client,
    ...
    pub fn upsert_account(&mut self, account: &DbAccountInfo) -> Result<(), GeyserPluginError> {
    ...
    pub fn insert_accounts_in_batch(
        &mut self,
        account: DbAccountInfo,
    ) -> Result<(), GeyserPluginError> {
    ...
    pub fn bulk_insert_accounts(&mut self) -> Result<(), GeyserPluginError> {
    ...
    pub fn flush_buffered_writes(&mut self) -> Result<(), GeyserPluginError> {
        let client = self.client.get_mut().unwrap();
        let insert_account_audit_stmt = &client.insert_account_audit_stmt;
        let statement = &client.update_account_stmt;
        let insert_token_owner_index_stmt = &client.insert_token_owner_index_stmt;
    ...
    pub fn upsert_slot_status_internal(
        slot: u64,
        parent: Option<u64>,
        status: SlotStatus,
        client: &mut Client,
